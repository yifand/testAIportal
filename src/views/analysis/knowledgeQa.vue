<template>
  <div class="analysis-qa" ref="pageContent">
    <div class="page-header" ref="pageHeader">
      ...
      <div class="page-subtitle">智能公路巡检知识问答，快速入门</div>
    </div>
        ...
        <div class="chat-container">
          ...
          <div class="chat-input" ref="chatInput">
            <div class="input-container">
              <el-input v-model="inputQuestion" type="textarea" :rows="3" placeholder="请输入您的问题？"
    ...
    changeMsg(res, isMsgEnd = false) {
      ...
      if (existingItem) {
        ...
        if (hasThink) {
          ...
          // 普通文本（首次）
          if (this.currentStreamingMessage) {
            // 累加到占位消息（修复 BUG：原来用 = 直接赋值会丢失已有内容）
